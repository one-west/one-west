...
- 그러나 어린 마음에 공부가 하기 싫어 놀기만 하였고, 본격적으로 개발 공부를 시작한 건 대학교 2학년부터이다.

- 처음에는 C언어를 공부하면서 컴퓨터적인 사고 익히는데 중점을 둔 것 같다.

- 다음은 JAVA를 공부하면서 객체지향언어(OOP)의 특징과 쓰임새를 알아가는 데 중점을 두었다.

- 이 후 Python, Node.js, Kotlin, Arduino 등 다양한 언어들을 짧게 경험하고, 현재는 JAVA 와 JavaScript 에 집중하고 있다.
